...
## [Exercício] Liderança em Scrum

De acordo com o que você adquiriu de conhecimento ao longo deste curso, qual estilo de liderança ideal para a condução de um projeto Scrum?
...
Liderança servidora é a mais adequada para conduzir projetos Scrum. Líderes Servidores empregam a escuta, a empatia, o comprometimento e a introspecção ao compartilhar poder e autoridade com os membros do time.

<br>

## [Exercício] Stakeholders

Como foi afirmado pelo professor nas últimas aulas, as opções abaixo são preocupações que o Time Scrum deve ter com os stakeholders, exceto:

- [ ] A) Envolver e manter colaborando
- [ ] B) Gerenciar as expectativas
- [x] C) Omitir status negativos do projeto
- [ ] D) Avaliar o impacto nos negócios

Para garantir o envolvimento dos stakeholders no projeto, é necessário manter a transparência do status do projeto.