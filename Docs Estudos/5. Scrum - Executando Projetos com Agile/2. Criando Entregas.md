...
## [Exercício] Prioridades Reais dos Clientes

O backlog atualizado vai ajudar tanto o dono do produto quanto o time scrum. Em qual evento deve ser assegurado que as Histórias de Usuário e os Critérios de Aceitação estão compreendidos e alinhados com as prioridades reais dos clientes?

- [ ] A) Reunião Diária
- [ ] B) Reunião da Retrospectiva do Projeto
- [ ] C) Reunião de Alinhamento das Prioridades
- [x] D) Reunião de Revisão do Backlog Priorizado do Produto e de Planejamento da Sprint.

A Reunião de Revisão do Backlog Priorizado do Produto deve assegurar que as Histórias de Usuário e os Critérios de Aceitação estão compreendidos e alinhados com as prioridades reais dos clientes. Também é importante realizar esta garantia durante as reuniões de planejamento.