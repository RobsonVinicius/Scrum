...
- [x] A) Scrum Master, Dono do Produto e Time de Desenvolvimento.
...
- [ ] A) As mudanças de requisitos são aceitas desde que as entregas não sejam alteradas.
...
Em um projeto ágil, é praticamente impossível que todos os requisitos sejam definidos no início do projeto. Esse paradigma já é considerado pelo Time Scrum, auto-organizado e flexível.